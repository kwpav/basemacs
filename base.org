...
* What is This?
This creates =base/base.el=, which is the starting config for =basemacs=. It is where all the defaults are set.
...
** Lexical Binding
Set up lexical binding in both =early-init.el= and =base/base.el=. The files need to start with this in order for it to work.
#+begin_src emacs-lisp :tangle early-init.el
  ;;; early-init.el --- -*- lexical-binding: t -*-
#+end_src

#+begin_src emacs-lisp :tangle base/base.el
...
* Modules
Add the =modules/= directory to our load path so the [[file:config.org][basemacs modules]] can be used in =init.el= (or wherever else really).
#+begin_src emacs-lisp :tangle base/base.el
